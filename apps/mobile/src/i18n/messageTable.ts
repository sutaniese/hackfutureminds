...
import { MOBILE_EXTRA } from "./mobileExtra";
...
const T = {
  ...
  "home.landing.step2.body": TR(
    "teñ. собирает карьерные направления, финансовый разрыв и подходящие программы.",
    "teñ. builds career directions, the funding gap and matching programs.",
    "teñ. карьера бағыттарын, қаржы ойысын және сәйкес бағдарламаларды жинайды.",
  ),
  ...
  "home.landing.footerGuest": TR(
    "Создайте один аккаунт, выберите роль — teñ. откроет нужное рабочее пространство.",
    "Create one account, choose a role, and teñ. sends you to the right workspace.",
    "Бір аккаунт жасап, рөлді таңдаңыз — teñ. дұрыс жұмыс аймағына жібереді.",
  ),
  ...
  "onboard.allSetBody": TR(
    "Анкета сохранена для вашего аккаунта. Повторно проходить её не нужно — откройте план или дорожную карту.",
    "Your questionnaire is saved to this account. You do not need to take it again — open the plan or roadmap.",
    "Анкета осы аккаунтқа сақталды. Қайта өтудің қажеті жоқ — жоспар немесе roadmap ашыңыз.",
  ),
  "onboard.toResults": TR("Смотреть план", "View results", "Нәтижелер"),
  "onboard.toRoadmap": TR("Дорожная карта", "Roadmap", "Жол картасы"),
