...
const T = {
  ...
  "home.landing.title": TR(
    "Карьера, гранты и портфолио в одном месте",
    "Career guidance, grants and portfolio in one place",
    "Карьера, гранттар және портфолио бір жерде",
  ),
  "home.landing.subtitle": TR(
    "Один профиль ученика — карта карьеры, стратегия грантов, семейный отчёт и панель для учителя. В духе современных приёмных платформ — для школьников Казахстана.",
    "One student profile becomes a career map, grant strategy, family report and teacher dashboard. Inspired by modern admissions platforms, built for Kazakhstan students.",
    "Бір оқушы профилі — карьера картасы, грант стратегиясы, отбасы есебі және мұғалім панелі. Қазіргі қабылдау платформаларына ұқсас — Қазақстан оқушыларына.",
  ),
  "home.landing.ctaPrimary": TR("Начать бесплатно", "Start free", "Тегін бастау"),
  "home.landing.ctaSecondary": TR("Смотреть гранты", "View grants", "Гранттарды көру"),
  "home.landing.stat1v": TR("3", "3", "3"),
  "home.landing.stat1l": TR("роли в одной системе", "roles in one system", "рөл бір жүйеде"),
  "home.landing.stat2v": TR("15–18", "15–18", "15–18"),
  "home.landing.stat2l": TR("лет, фокус ученика", "years, student focus", "жас, оқушыға назар"),
  "home.landing.stat3v": TR("KZ", "KZ", "KZ"),
  "home.landing.stat3l": TR("гранты и вузы", "grants & universities", "гранттар мен ЖОО"),
  "home.landing.stat4v": TR("AI", "AI", "AI"),
  "home.landing.stat4l": TR("план + портфолио", "plan + portfolio", "жоспар + портфолио"),
  "home.landing.accountKicker": TR("НАСТРОЙКА АККАУНТА", "ACCOUNT SETUP", "АККАУНТТЫ БАПТАУ"),
  "home.landing.accountTitle": TR("Постройте свой путь", "Build your path", "Өз жолыңызды құрыңыз"),
  "home.landing.accountItem1": TR("Направление карьеры", "Career direction", "Карьера бағыты"),
  "home.landing.accountItem2": TR("Подбор грантов", "Grant matching", "Грант сәйкестігі"),
  "home.landing.accountItem3": TR("Блок портфолио", "Portfolio block", "Портфолио блогы"),
  ...
  "home.landing.nextText": TR(
    "Выберите роль и войдите в нужный кабинет.",
    "Choose your role and enter the right dashboard.",
    "Рөлді таңдаңыз және керек кабинетке кіріңіз.",
  ),
  ...
  "home.entry.student.title": TR("Начать свой карьерный путь", "Start your career path", "Карьера жолын бастау"),
  "home.entry.student.body": TR(
    "Пройти анкету, получить план, гранты и собрать портфолио.",
    "Run the questionnaire, get your plan, grants and portfolio.",
    "Анкетадан өтіп, жоспар, гранттар мен портфолио алу.",
  ),
  "home.entry.student.badge": TR("Студент", "Student", "Студент"),
  "home.entry.student.metric": TR("7 шагов", "7 steps", "7 қадам"),
  ...
  "home.why.title": TR(
    "Больше, чем тест. Полная система сопровождения.",
    "More than a quiz. A full guidance system.",
    "Тесттен көп. Толық бағыт-бағдарлау жүйесі.",
  ),
  "home.why.lead": TR(
    "Как Qapps упрощает поступление в один профиль, PathWise превращает карьерное сопровождение в единый процесс для школы, семьи и ученика.",
    "Like Qapps simplifies university applications into one profile, PathWise turns career guidance into one connected workflow for school, family and student.",
    "Qapps университетке түсу бір профильге жеңілдетсе, PathWise карьералық сүйемелдеуді мектеп, отбасы және оқушы үшін бір үдеріске айналдырады.",
  ),
  "home.why.1": TR(
    "Карьерная карта с зарплатами в KZT и ссылками на вакансии.",
    "Career map with KZT salaries and job links.",
    "KZT жалақысы және жұмыс сілтемелері бар карьера картасы.",
  ),
  "home.why.2": TR(
    "Каталог грантов с уровнями совпадения High / Medium / Low.",
    "Grant catalog with High / Medium / Low match levels.",
    "High / Medium / Low сәйкестігі бар грант каталогы.",
  ),
  "home.why.3": TR(
    "Портфолио и достижения в формате для поступления.",
    "Portfolio and achievements in an admissions-ready format.",
    "Түсуге дайын портфолио және жетістіктер.",
  ),
  "home.why.4": TR(
    "Teacher hub: классы, инвайт-коды, CSV и рекомендательные письма.",
    "Teacher hub: classes, invite codes, CSV and recommendation letters.",
    "Teacher hub: сыныптар, шақыру кодтары, CSV және ұсыныс хаттары.",
  ),
